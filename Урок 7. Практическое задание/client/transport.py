...
from globals.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, \
    RESPONSE, ERROR, MESSAGE, SENDER, DESTINATION, MESSAGE_TEXT, GET_CONTACTS, \
    LIST_INFO, USERS_REQUEST, ADD_CONTACT, CONTACT, REMOVE_CONTACT, EXIT, \
