...
from globals.variables import MAX_CONNECTIONS, DESTINATION, SENDER, ACTION, \
    ACCOUNT_NAME, USER, RESPONSE_200, RESPONSE_400, ERROR, MESSAGE, \
    MESSAGE_TEXT, TIME, EXIT, GET_CONTACTS, RESPONSE_202, LIST_INFO, \
    ADD_CONTACT, CONTACT, REMOVE_CONTACT, USERS_REQUEST, PRESENCE, RESPONSE, \
    PUBLIC_KEY, DATA, RESPONSE_205, RESPONSE_511, PUBLIC_KEY_REQUEST
...
class Server(threading.Thread):
    ...
    def init_socket(self):
        log.info(
            f'Запущен сервер, порт: {self.port}, '
    ...
    def process_message(self, message):
        if message[DESTINATION] in self.names \
            ...
            try:
                ...
                log.info(
                    f'Отправлено сообщение --> {message[DESTINATION]} '
            ...
            log.error(
                f'Связь с клиентом {message[DESTINATION]} потеряна. '
            ...
            log.error(
                ...
                f'не зарегистрирован, отправка сообщения невозможна')
    ...
    def autorize_user(self, message, sock):
        ...
        # Проверяем что пользователь зарегистрирован на сервере
            ...
            # Иначе отвечаем 511 и проводим процедуру авторизации. Словарь -
            # заготовка:
